...
export default function Terms() {
  return (
    <div className='mx-6 mt-20 md:mx-48 h-screen'>
      ...
      <div className='md:mt-8'>
        <p className='font-semibold text-center'>
          Вы соглашаетесь быть связанными нашими <Link to='/rules' className='hover:text-purple-800 hover:cursor-pointer'><strong>правилами</strong></Link> сайта и любыми
